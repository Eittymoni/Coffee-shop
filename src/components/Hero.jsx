  ...
  return (
    <main style={bgImg}>
        ...
        <div className="container">
            {/*navbar section */}
            <Navber sidebar={sidebar} setSidebar={ setSidebar}/>
            {/* hero section*/}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center min-h-[850px]">
            ...
            <div className="text-lightOrange mt-[100px] md:mt-0 p-4 space-y-28 ">
                ...
                className=' opacity-0 text-7xl font-bold leading-tight ml-14 '> Blvck Tumler</motion.h1>
                ...
                className='relative'>
                    <div className='relative z-10 space-y-4'>
                        ...
                        <h1 className='text-sm opacity-55 leading-loose'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis omnis natus vel sed veritatis nulla vero nam culpa quos, voluptatem quia quis, quidem obcaecati .</h1>
                    </div>
            ...
            className="text-lightOrange mt-[100px]md:mt-0 p-4 space-y-28 ">
                <h1 className=' opacity-0 text-7xl font-bold leading-tight ml-14 '> Blvck Tumler</h1>
                <div className='relative'>
                    <div className='relative z-10 space-y-4'>
                        <h1 className='text-2xl'>Blvck Tumler</h1>
                        <h1 className='text-sm opacity-55 leading-loose'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis omnis consectetur adipisicing elit. Perspiciatis omnis consectetur adipisicing elit. Perspiciatis omnis  .</h1>
                    </div>
                    <div className="absolute -top-6 -right-10 w-[250px] 
                    h-[190px] bg-darkGray/50"></div>
                </div>
            </motion.div>
